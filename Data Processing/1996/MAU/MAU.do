cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/MAU"

capture log close
set more off
log using MAU.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains MAU
// $ grep -l 'MAU' *.txt
...
save MAU.dta, replace emptyok

// for each data file, keep the row that has MAU information and append to the big data file
...
append using MAU.dta
save MAU.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using MAU.csv, comma
