cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/NIN"

capture log close
set more off
log using NIN.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains NIN
// $ grep -l 'NIN' *.txt
...
save NIN.dta, replace emptyok

// for each data file, keep the row that has NIN information and append to the big data file
...
keep if code == "NIN"
append using NIN.dta
save NIN.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using NIN.csv, comma
