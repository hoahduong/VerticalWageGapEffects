...
# No Zone
#mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1997 Ladders/Plots/Level Regression/NoZone.jpeg")
...
title(main = "Quadratic Fit to Pay Level (1997 - Type 1)")
box()
par(op)
...
# No Zone No Area
#mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1997 Ladders/Plots/Level Regression/NoZoneNoArea.jpeg")
#jpeg(file=mypath, width = 600, height = 600, units = "px", quality = 100)
...
title(ylab = "Pay level ($)", line = 4.25, cex.lab = 1)
title(main = "Quadratic Fit to Pay Level (1997 - Type 2)")
box()
par(op)
