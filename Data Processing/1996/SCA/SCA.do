cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/SCA"

capture log close
set more off
log using SCA.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains SCA
// $ grep -l 'SCA' *.txt
...
save SCA.dta, replace emptyok

// for each data file, keep the row that has SCA information and append to the big data file
...
keep if code == "SCA"
append using SCA.dta
save SCA.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using SCA.csv, comma
