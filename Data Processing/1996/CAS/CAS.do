cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/CAS"

capture log close
set more off
log using CAS.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains CAS
// $ grep -l 'CAS' *.txt
...
save CAS.dta, replace emptyok

// for each data file, keep the row that has CAS information and append to the big data file
...
append using CAS.dta
save CAS.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using CAS.csv, comma
