cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/STE"

capture log close
set more off
log using STE.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains STE
// $ grep -l 'STE' *.txt
...
save STE.dta, replace emptyok

// for each data file, keep the row that has STE information and append to the big data file
...
keep if code == "STE"
append using STE.dta
save STE.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using STE.csv, comma
