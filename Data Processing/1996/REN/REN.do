cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/REN"

capture log close
set more off
log using REN.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains REN
// $ grep -l 'REN' *.txt
...
save REN.dta, replace emptyok

// for each data file, keep the row that has REN information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // name
gen fileName = "`fileName'"
if fileName == "44 Third Key.txt" {
	drop comments
	}
keep if code == "REN"
append using REN.dta
save REN.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using REN.csv, comma
