...
# Plot
#mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1997 Ladders/Plots/Combined/Level.jpeg")
...
boxplot(noZone$AsstStoreMgr, noZoneNoArea$AsstStoreMgr, 
        ...
        main = "Pay Level (1997)", axes = FALSE, ann = FALSE)
...
# Plot
#mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1997 Ladders/Plots/Combined/First Difference.jpeg")
#jpeg(file=mypath, width = 600, height = 600, units = "px", quality = 100)
...
boxplot(firstDiffNZ$AsstToStore, firstDiffNZNA$AsstToStore,
        ...
        col = c("blue", "red", "blue", "red", "blue", 
                "blue", "red", "blue", "red"), 
        main = "First Difference (1997)", axes = FALSE, ann = FALSE)
...
# Plot
#mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1997 Ladders/Plots/Combined/Second Difference.jpeg")
#jpeg(file=mypath, width = 600, height = 600, units = "px", quality = 100)
...
boxplot(secondDiffNZ$AsstToStoreVSStoreToArea, 
        ...
        col = c("blue", "red", "blue", "blue", "red",
                "blue", "red"), 
        main = "Second Difference (1997)", axes = FALSE, ann = FALSE)
...
title(ylab = "Difference between pay gaps ($)", line = 4.2, cex.lab = 1)
box()
