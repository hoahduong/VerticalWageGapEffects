cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/GAP"

capture log close
set more off
log using GAP.log, replace
...
// for each data file, keep the row that has GAP information and append to the big data file
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using GAP.csv, comma
