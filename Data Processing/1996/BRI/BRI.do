...
capture log close
set more off
log using BRI.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains BRI
// $ grep -l 'BRI' *.txt
...
save BRI.dta, replace emptyok

// for each data file, keep the row that has BRI information and append to the big data file
...
append using BRI.dta
save BRI.dta, replace 
}
