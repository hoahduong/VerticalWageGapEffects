...
# Plot
mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1996 Ladders/Superseded/Plots/Combined/Level.jpeg")
...
# Plot
mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1996 Ladders/Superseded/Plots/Combined/First Difference.jpeg")
jpeg(file=mypath, width = 600, height = 600, units = "px", quality = 100)
...
# Plot
mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1996 Ladders/Superseded/Plots/Combined/Second Difference.jpeg")
jpeg(file=mypath, width = 600, height = 600, units = "px", quality = 100)
