cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/WIL"

capture log close
set more off
log using WIL.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains WIL
// $ grep -l 'WIL' *.txt
...
save WIL.dta, replace emptyok

// for each data file, keep the row that has WIL information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "WIL"
gen fileName = "`fileName'"
append using WIL.dta
save WIL.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using WIL.csv, comma
