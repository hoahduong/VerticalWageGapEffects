cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/JBA"

capture log close
set more off
log using JBA.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains JBA
// $ grep -l 'JBA' *.txt
...
save JBA.dta, replace emptyok

// for each data file, keep the row that has JBA information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "JBA"
gen fileName = "`fileName'"
append using JBA.dta
save JBA.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using JBA.csv, comma
