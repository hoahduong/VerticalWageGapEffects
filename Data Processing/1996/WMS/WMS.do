cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/WMS"

capture log close
set more off
log using WMS.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains WMS
// $ grep -l 'WMS' *.txt
...
save WMS.dta, replace emptyok

// for each data file, keep the row that has WMS information and append to the big data file
...
append using WMS.dta
save WMS.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using WMS.csv, comma
