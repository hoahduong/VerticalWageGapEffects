cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/CAM"

capture log close
set more off
log using CAM.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains CAM
// $ grep -l 'CAM' *.txt
...
save CAM.dta, replace emptyok

// for each data file, keep the row that has CAM information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "CAM"
gen fileName = "`fileName'"
append using CAM.dta
save CAM.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using CAM.csv, comma
