...
capture log close
set more off
log using GEN.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains GEN
// $ grep -l 'GEN' *.txt
...
save GEN.dta, replace emptyok

// for each data file, keep the row that has GEN information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "GEN"
gen fileName = "`fileName'"
append using GEN.dta
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using GEN.csv, comma
