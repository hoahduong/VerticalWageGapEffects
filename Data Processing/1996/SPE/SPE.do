cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/SPE"

capture log close
set more off
log using SPE.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains SPE
// $ grep -l 'SPE' *.txt
...
save SPE.dta, replace emptyok

// for each data file, keep the row that has SPE information and append to the big data file
...
append using SPE.dta
save SPE.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using SPE.csv, comma
