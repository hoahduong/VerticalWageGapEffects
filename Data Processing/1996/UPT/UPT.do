cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/UPT"

capture log close
set more off
log using UPT.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains UPT
// $ grep -l 'UPT' *.txt
...
save UPT.dta, replace emptyok

// for each data file, keep the row that has UPT information and append to the big data file
...
append using UPT.dta
save UPT.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using UPT.csv, comma
