cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/DRE"

capture log close
set more off
log using DRE.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains DRE
// $ grep -l 'DRE' *.txt
...
save DRE.dta, replace emptyok

// for each data file, keep the row that has DRE information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "DRE"
gen fileName = "`fileName'"
append using DRE.dta
save DRE.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using DRE.csv, comma
