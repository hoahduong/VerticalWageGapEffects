cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/MAN"

capture log close
set more off
log using MAN.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains MAN
// $ grep -l 'MAN' *.txt
...
save MAN.dta, replace emptyok

// for each data file, keep the row that has MAN information and append to the big data file
...
append using MAN.dta
save MAN.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using MAN.csv, comma
