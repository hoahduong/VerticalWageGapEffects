...
capture log close
set more off
log using GAPData_v3.log, replace
...
drop _all 
save allGap_v3.dta, replace emptyok
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "GAP"
gen fileName = "`fileName'"
append using allGap_v3.dta
save allGap_v3.dta, replace 
}
...
outsheet code base bonus total hire reports title reportsto fileName payGap using allGap_v3.csv, comma
