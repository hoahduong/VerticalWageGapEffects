cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/PAY"

capture log close
set more off
log using PAY.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains PAY
// $ grep -l 'PAY' *.txt
...
save PAY.dta, replace emptyok

// for each data file, keep the row that has PAY information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "PAY"
gen fileName = "`fileName'"
append using PAY.dta
save PAY.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using PAY.csv, comma
