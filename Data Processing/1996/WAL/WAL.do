cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/WAL"

capture log close
set more off
log using WAL.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains WAL
// $ grep -l 'WAL' *.txt
...
save WAL.dta, replace emptyok

// for each data file, keep the row that has WAL information and append to the big data file
...
append using WAL.dta
save WAL.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using WAL.csv, comma
