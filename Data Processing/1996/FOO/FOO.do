cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/FOO"

capture log close
set more off
log using FOO.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains FOO
// $ grep -l 'FOO' *.txt
...
save FOO.dta, replace emptyok

// for each data file, keep the row that has FOO information and append to the big data file
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using FOO.csv, comma
