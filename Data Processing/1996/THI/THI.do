cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/THI"

capture log close
set more off
log using THI.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains THI
// $ grep -l 'THI' *.txt
...
save THI.dta, replace emptyok

// for each data file, keep the row that has THI information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "THI"
gen fileName = "`fileName'"
append using THI.dta
save THI.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using THI.csv, comma
