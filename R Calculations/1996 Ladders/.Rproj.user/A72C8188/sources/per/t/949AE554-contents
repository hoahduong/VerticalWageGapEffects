...
for (i in 1:nrow(noZone)) {
  ...
  if (secondDiffNZ[i,4] >= 0 && secondDiffNZ[i,5] >= 0 
...
for (i in 1:nrow(noZoneNoArea)) {
  ...
  if (secondDiffNZNA[i,4] >= 0 && secondDiffNZNA[i,5] >= 0 
...
boxplot(structureNZ$Volume / 1000 ~ structureNZ$Structure, 
        col = c("blue", "cyan"),
        main = "Volume Comparison (1996 - Type 1)", axes = FALSE, ann = FALSE)
...
boxplot(structureNZNA$Volume / 1000 ~ structureNZNA$Structure,
        ...
        main = "Volume Comparison (1996 - Type 2)", axes = FALSE, ann = FALSE)
...
boxplot(allStruct$Volume / 1000 ~ allStruct$Structure, 
        ...
        main = "Volume Comparison (1996)", axes = FALSE, ann = FALSE)
