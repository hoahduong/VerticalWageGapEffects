cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/WOO"

capture log close
set more off
log using WOO.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains WOO
// $ grep -l 'WOO' *.txt
...
save WOO.dta, replace emptyok

// for each data file, keep the row that has WOO information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "WOO"
gen fileName = "`fileName'"
append using WOO.dta
save WOO.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using WOO.csv, comma
