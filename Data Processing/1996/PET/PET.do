cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/PET"

capture log close
set more off
log using PET.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains PET
// $ grep -l 'PET' *.txt
...
save PET.dta, replace emptyok

// for each data file, keep the row that has PET information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "PET"
gen fileName = "`fileName'"
append using PET.dta
save PET.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using PET.csv, comma
