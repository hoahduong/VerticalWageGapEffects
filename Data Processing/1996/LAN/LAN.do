cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/LAN"

capture log close
set more off
log using LAN.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains LAN
// $ grep -l 'LAN' *.txt
...
save LAN.dta, replace emptyok

// for each data file, keep the row that has LAN information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "LAN"
gen fileName = "`fileName'"
append using LAN.dta
save LAN.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using LAN.csv, comma
