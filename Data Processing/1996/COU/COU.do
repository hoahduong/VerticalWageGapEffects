cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/COU"

capture log close
set more off
log using COU.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains COU
// $ grep -l 'COU' *.txt
...
save COU.dta, replace emptyok

// for each data file, keep the row that has COU information and append to the big data file
...
append using COU.dta
save COU.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using COU.csv, comma
