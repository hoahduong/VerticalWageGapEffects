cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/COA"

capture log close
set more off
log using COA.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains COA
// $ grep -l 'COA' *.txt
...
save COA.dta, replace emptyok

// for each data file, keep the row that has COA information and append to the big data file
foreach fileName in "`fileList'" {
import delimited using "`pathName'`fileName'",  clear // names
keep if code == "COA"
gen fileName = "`fileName'"
append using COA.dta
save COA.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using COA.csv, comma
