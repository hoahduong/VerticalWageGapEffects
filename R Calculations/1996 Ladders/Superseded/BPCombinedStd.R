...
# Plot
mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1996 Ladders/Superseded/Plots/Combined/Standardized Level.jpeg")
...
# Plot
mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1996 Ladders/Superseded/Plots/Combined/Standardized First Difference.jpeg")
jpeg(file=mypath, width = 600, height = 600, units = "px", quality = 100)
...
# Plot
mypath <- file.path("~/Desktop/18-19 Thesis/R Calculations/1996 Ladders/Superseded/Plots/Combined/Standardized Second Difference.jpeg")
jpeg(file=mypath, width = 600, height = 600, units = "px", quality = 100)
