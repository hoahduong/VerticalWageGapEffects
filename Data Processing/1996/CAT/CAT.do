cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/CAT"

capture log close
set more off
log using CAT.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains CAT
// $ grep -l 'CAT' *.txt
...
save CAT.dta, replace emptyok

// for each data file, keep the row that has CAT information and append to the big data file
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using CAT.csv, comma
