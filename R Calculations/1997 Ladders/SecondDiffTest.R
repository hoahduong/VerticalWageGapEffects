...
boxplot(structureNZ$Volume / 1000 ~ structureNZ$Structure, 
        col = c("blue", "cyan"),
        main = "Volume Comparison (1997 - Type 1)", axes = FALSE, ann = FALSE)
...
boxplot(structureNZNA$Volume / 1000 ~ structureNZNA$Structure,
        ...
        main = "Volume Comparison (1997 - Type 2)", axes = FALSE, ann = FALSE)
...
boxplot(allStruct$Volume / 1000 ~ allStruct$Structure, 
        ...
        main = "Volume Comparison (1997)", axes = FALSE, ann = FALSE)
