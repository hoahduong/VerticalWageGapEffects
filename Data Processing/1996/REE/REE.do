cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/REE"

capture log close
set more off
log using REE.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains REE
// $ grep -l 'REE' *.txt
...
save REE.dta, replace emptyok

// for each data file, keep the row that has REE information and append to the big data file
...
append using REE.dta
save REE.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using REE.csv, comma
