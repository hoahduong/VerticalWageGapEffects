cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/BRO"

capture log close
set more off
log using BRO.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains BRO
// $ grep -l 'BRO' *.txt
...
save BRO.dta, replace emptyok

// for each data file, keep the row that has BRO information and append to the big data file
...
append using BRO.dta
save BRO.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using BRO.csv, comma
