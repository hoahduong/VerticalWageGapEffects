cd "/Users/macbook/Desktop/18-19 Thesis/Data Processing/1996/TAL"

capture log close
set more off
log using TAL.log, replace

version 15

local pathName "/Users/macbook/Desktop/18-19 Thesis/fromBefore/theData/1996/"

// use the grep command to get the list of files that contains TAL
// $ grep -l 'TAL' *.txt
...
save TAL.dta, replace emptyok

// for each data file, keep the row that has TAL information and append to the big data file
...
append using TAL.dta
save TAL.dta, replace 
}
...
//outsheet code base bonus total hire reports title reportsto fileName payGap using TAL.csv, comma
